...
public class MemoryContainerHelperTests extends OpenSearchTestCase {
    ...
    public void testConvertBulkRequestToNDJSON_UpdateRequest() throws Exception {
        ...
        UpdateRequest updateRequest = new UpdateRequest("test-index", "doc1")
    ...
    public void testConvertBulkRequestToNDJSON_RealWorldExample() throws Exception {
        ...
        String docJson = "{\"created_time\":1760760969707,\"memory\":\"Bob likes swimming.\",\"last_updated_time\":1760760969707,\"namespace_size\":1,\"owner_id\":\"admin\",\"namespace\":{\"user_id\":\"bob\"},\"strategy_id\":\"semantic_9766b0fe\",\"strategy_type\":\"SEMANTIC\",\"memory_container_id\":\"B4DU85kBZsSZwpNve_T0\",\"tags\":{\"topic\":\"personal info\"}}";
        
        IndexRequest indexRequest = new IndexRequest("demo2-memory-long-term")
            .source(docJson);
