...
@Log4j2
public class RestMLStreamPredictionAction extends BaseRestHandler {
    private static final String ML_PREDICTION_ACTION = "ml_stream_prediction_action";
     ...
     * Constructor
     */
    public RestMLStreamPredictionAction(MLModelManager modelManager, MLFeatureEnabledSetting mlFeatureEnabledSetting) {
    ...
    public List<Route> routes() {
        return ImmutableList
            .of(
                new Route(RestRequest.Method.POST, String.format(Locale.ROOT, "%s/models/{%s}/_predict_stream", ML_BASE_URI, PARAMETER_MODEL_ID))
            );
    }
            ...
            Flux
                    ...
                    .doOnSuccess(bytesReference -> {
                        try {
                            ...
                            client.execute(MLPredictionTaskAction.INSTANCE, taskRequest, new StreamPredictActionListener<MLTaskResponse>() {
                                @Override
                                public void onStreamResponse(MLTaskResponse mlTaskResponse) {
