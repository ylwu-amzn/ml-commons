...
public class RemoteStorageHelper {
    ...
    // ==================== Embedding Model Creation Methods ====================
    /**
    ...
    // /**
    // * Builds connector configuration for embedding model based on provider
    // */
    // private static String buildEmbeddingModelConnectorConfig(
    // org.opensearch.ml.common.memorycontainer.RemoteEmbeddingModel embeddingModel,
    // Map<String, String> remoteStoreCredential
    // ) {
    // String provider = embeddingModel.getProvider();
    ...
    //// return buildBedrockEmbeddingConnectorConfig(provider, embeddingModel, remoteStoreCredential);
    //// }
    // return buildBedrockEmbeddingConnectorConfig(provider, embeddingModel, remoteStoreCredential);
    //
    // // Add support for other providers (OpenAI, Cohere, etc.) as needed
