    ...
    protected void executeTask(MLPredictionTaskRequest request, ActionListener<MLTaskResponse> listener) {
        ...
        switch (inputDataType) {
            case SEARCH_QUERY:
                ...
                mlInputDatasetHandler.parseSearchQueryInput(mlInput.getInputDataset(), threadedActionListener(functionName, dataFrameActionListener));
                break;
            case DATA_FRAME:
            case TEXT_DOCS:
            default:
    ...
    private void predict(String modelId, MLTask mlTask, MLInput mlInput, ActionListener<MLTaskResponse> listener) {
        ...
        if (modelId != null) {
            ...
            try (ThreadContext.StoredContext context = threadPool.getThreadContext().stashContext()) {
                ...
                client.get(getRequest, threadedActionListener(mlTask.getFunctionName(), ActionListener.runBefore(getModelListener, () -> context.restore())));
            } catch (Exception e) {
