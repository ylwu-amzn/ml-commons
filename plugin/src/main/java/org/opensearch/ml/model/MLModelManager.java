    ...
    public void loadModel(
        ...
        try (ThreadContext.StoredContext context = client.threadPool().getThreadContext().stashContext()) {
            ...
            this.getModel(modelId, threadedActionListener(LOAD_THREAD_POOL, ActionListener.wrap(mlModel -> {
                if (mlModel.getAlgorithm() != FunctionName.TEXT_EMBEDDING && mlModel.getAlgorithm() != FunctionName.QUESTION_ANSWERING) {// load model trained by built-in algorithm like kmeans
