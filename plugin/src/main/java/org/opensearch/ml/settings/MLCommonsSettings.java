...
public final class MLCommonsSettings {
    ...
    public static final Setting<Integer> ML_COMMONS_MAX_LOAD_MODEL_TASKS_PER_NODE = Setting
        .intSetting("plugins.ml_commons.max_load_model_tasks_per_node", 1, 0, 1000, Setting.Property.NodeScope, Setting.Property.Dynamic);
    ...
    public static final Setting<Integer> ML_COMMONS_MAX_UPLOAD_TASKS_PER_NODE = Setting
        .intSetting("plugins.ml_commons.upload_tasks_per_node", 1, 1, 10, Setting.Property.NodeScope, Setting.Property.Dynamic);
}
