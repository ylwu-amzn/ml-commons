...
public class MLUploadInput implements ToXContentObject, Writeable {
    ...
    public MLUploadInput(StreamInput in) throws IOException {
        ...
        if (in.readBoolean()) {
            this.modelConfig = new TextEmbeddingModelConfig(in);//TODO: add this into class loader
        }
    }
        ...
        while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
            ...
            switch (fieldName) {
                ...
                case MODEL_CONFIG_FIELD:
                    modelConfig = TextEmbeddingModelConfig.parse(parser);//TODO: move this to class loader
                    break;
                default:
                    parser.skipChildren();
                    break;
