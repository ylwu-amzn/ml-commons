...
package org.opensearch.ml.common.transport.custom_model.load;
...
public class LoadModelInput implements ToXContentObject, Writeable {
    ...
    @Builder
    public LoadModelInput(String modelId, String taskId, Integer nodeCount, String coordinatingNodeId, MLTask mlTask) {
    ...
    public static LoadModelInput parse(XContentParser parser) throws IOException {
        ...
        return new LoadModelInput(modelId, taskId, nodeCount, coordinatingNodeId, mlTask);
    }
