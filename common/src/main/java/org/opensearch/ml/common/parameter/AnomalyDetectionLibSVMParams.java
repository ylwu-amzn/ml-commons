...
@Data
@MLAlgoParameter(algorithms={FunctionName.ANOMALY_DETECTION_LIBSVM})
public class AnomalyDetectionLibSVMParams implements MLAlgoParams {
    public static final String PARSE_FIELD_NAME = FunctionName.ANOMALY_DETECTION_LIBSVM.name();
    ...
    @Builder
    public AnomalyDetectionLibSVMParams(Double gamma, Double nu) {
        this.gamma = gamma;
        this.nu = nu;
    }
    ...
    private static MLAlgoParams parse(XContentParser parser) throws IOException {
        ...
        return new AnomalyDetectionLibSVMParams(gamma, nu);
    }
