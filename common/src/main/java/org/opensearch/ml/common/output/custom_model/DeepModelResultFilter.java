...
public class DeepModelResultFilter implements Writeable {
    ...
    public DeepModelResultFilter(boolean returnBytes,
    ...
    public DeepModelResultFilter(StreamInput streamInput) throws IOException {
